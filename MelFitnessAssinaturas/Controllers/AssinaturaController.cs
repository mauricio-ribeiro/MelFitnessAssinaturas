...
namespace MelFitnessAssinaturas.Controllers
{
    public class AssinaturaController
    {
        ...
        public void AlterarDataFaturameto(string idTabela)
        {
            try
            {
                var assinaturaDb = assinaturaDal.GetAssinaturaDb(idTabela);
                assinaturaApi.AlteraDataFaturamentoAssinatura(assinaturaDb);
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message);
        ...
        public void AlterarDataInicio(string idTabela, int dias)
        {
            try
            {
                var assinaturaDb = assinaturaDal.GetAssinaturaDb(idTabela);
                assinaturaApi.AlteraDataInicioAssinatura(assinaturaDb.Id_Api, dias);
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message);
