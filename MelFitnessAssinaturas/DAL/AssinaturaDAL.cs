...
namespace MelFitnessAssinaturas.DAL
{
    public class AssinaturaDal
    {
        ...
        public int AssinaturaCanceladaAtualizaStatus(string _code)
        {
            const string metodo = "AssinaturaCanceladaAtualizaStatus";
            ...
            try
            {
                ...
                sql.Append("update rec_assinatura set status = 'C' where id = @id");
